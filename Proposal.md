...
The first use case, half-way between mundane and revolutionary, use case for this solution would be "iframes without the performance (and rectangular topology) penalty".
